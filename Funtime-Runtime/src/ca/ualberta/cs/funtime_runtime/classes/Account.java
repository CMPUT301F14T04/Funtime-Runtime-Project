...
/**
 * A class for storing the user's account information. This allows the user to
 * have lists specific to them, such as favourites, read later, history, etc.
 * Also allows us to indicate that a user has upvoted or favourited a question
...
public class Account implements Serializable {
	...
	/**
	 * Constructor for a new account. Initializes a new account with a empty
	 * lists for favourites, user answers, user questions, read later, history,
	 * and upvoted questions and answers lists
	 * 
	 * @param username
	 *            a string used as a unique identifier for the user
	 */
	 ...
	 * 
	 * @param question
	 *            A question asked by the user that has been added to the master
	 *            questsion list
	 */
	...
	/**
	 * @param i
	 *            the index of the question to be returned
	 ...
	 * 
	 * @param answer
	 *            An answer posted by the user that has been added to the answer
	 *            list of its parent question
	 */
	...
	/**
	 * @param i
	 *            the index of the answer to be returned
	 ...
	 * 
	 * @param question
	 *            a question the user has indicated they want to favourite
	 */
	 ...
	 * 
	 * @param question
	 *            a question the user has indicated they want to remove from
	 *            favourites
	 */
	 ...
	 * 
	 * @param question
	 *            a question the user has indicated they want to save to read
	 *            later
	 */
	 ...
	 * 
	 * @param question
	 *            a question to be removed from the read later list
	 */
	 ...
	 * 
	 * @param question
	 *            a question the user has viewed
	 */
	 ...
	 * 
	 * @param question
	 *            a question the user has upvoted
	 */
	 ...
	 * 
	 * @param question
	 *            a question the user has un-upvoted
	 */
	 ...
	 * 
	 * @param answer
	 *            an answer the user has upvoted
	 */
	public void upvoteAnswer(Answer answer, Context context) {
		...
		try {
			...
			if ((ApplicationState.isOnline(context))) {
				ApplicationState.updateServerQuestion(ApplicationState
						.getQuestionById(a.getParentQuestionId(), context));
			} else {
				ApplicationState.addOfflineAnswerUpvote(
						new OfflineAnswer(a.getId(), a.getParentQuestionId()),
						context);
			}
			ApplicationState.cacheQuestion(ApplicationState.getQuestionById(
					a.getParentQuestionId(), context), context);
			ApplicationState.updateAccount(context);
		} catch (Exception e) {
			e.printStackTrace();
		}
	 ...
	 * 
	 * @param answer
	 *            an answer the user has un-upvoted
	 */
